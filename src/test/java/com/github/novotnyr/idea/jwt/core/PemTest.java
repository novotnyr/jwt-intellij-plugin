...
public class PemTest {
    @Test
    public void testWritePem() throws IOException {
        ...
        RS256SignatureContext context = new RS256SignatureContext.Builder()
                .withPrivateKey(priv)
                .withPublicKey(pub)
                .build();
        ...
        pemWriter.writeObject(context.getPrivateKey());
        pemWriter.flush();

        Assert.assertEquals(priv, out.toString());
    }
}
